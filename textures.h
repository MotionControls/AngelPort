...
extern unsigned long _binary_res_bg1_tim_start[];
extern unsigned long _binary_res_bg2_tim_start[];
...
void InitTextures(){
	...
	LoadTexture(_binary_res_objs4_tim_start, timBG1);
	LoadTexture(_binary_res_objs4_tim_start, timBG2);
}
